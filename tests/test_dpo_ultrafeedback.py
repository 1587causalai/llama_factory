#!/usr/bin/env python
# coding=utf-8
"""测试使用 UltraFeedback 数据集进行 DPO 训练"""
...
def test_dpo_ultrafeedback():
    print_section("DPO with UltraFeedback Dataset Testing")
    ...
    config_file = os.path.join(os.path.dirname(__file__), "configs", "test_dpo_ultrafeedback.yaml")

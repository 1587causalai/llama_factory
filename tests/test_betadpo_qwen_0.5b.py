"""
测试 Qwen1.5-0.5B-Chat 模型的 Learnable Beta DPO 训练流程
"""
import os
import sys
import yaml
...
def test_betadpo_qwen_0_5b():
    print_section("Learnable Beta DPO with Qwen1.5-0.5B-Chat Testing")
    ...
    # 3. 运行 Learnable Beta DPO 训练
    print_section("2. Learnable Beta DPO 训练开始")
    ...
    try:
        ...
        rprint("[green]Learnable Beta DPO 训练完成![/green]")
